import { ChangeDetectorRef, ElementRef, EmbeddedViewRef, OnChanges, OnDestroy, OnInit, SimpleChanges, TemplateRef, Type, ViewContainerRef } from '@angular/core';
...
export declare class TranslocoDirective implements OnInit, OnDestroy, OnChanges {
    ...
    constructor(translocoService: TranslocoService, tpl: TemplateRef<ViewContext>, providerScope: MaybeArray<TranslocoScope>, providerLang: string | undefined, providedLoadingTpl: Type<unknown> | string, vcr: ViewContainerRef, cdr: ChangeDetectorRef, host: ElementRef);
    ngOnInit(): void;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<TranslocoDirective, [null, { optional: true; }, { optional: true; }, { optional: true; }, { optional: true; }, null, null, null]>;
