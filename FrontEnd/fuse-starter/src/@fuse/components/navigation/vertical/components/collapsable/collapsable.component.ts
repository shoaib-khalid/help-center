...
export class FuseVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    toggleCollapsable(): void
    {
        ...
        if ( this.isCollapsed )
        {
            this.getChildren();
            this.expand();
           // this.posting_id = this.topics_id;
    ...
    getChildren()
    {
        this.httpClient.get<any>('http://localhost:8080/help-centre/topics/subtopics/b856f3aa-fcdb-4248-ae4f-220248c6000d').subscribe(
            result => {
             
                this.sub_topics = result;
                console.log(result);
